...
VALUES
  ...
  ('superread', 'SuperRead', 'RSS 订阅与 AI 简报', TRUE, TRUE, 'enabled', 'http://127.0.0.1:8002', 'XiaoleC05/SuperRead', 'https://github.com/XiaoleC05/SuperRead/releases'),
  ...
  ('aihelper', 'AIHelper', '提示词助手', TRUE, TRUE, 'enabled', 'http://127.0.0.1:8004', 'XiaoleC05/AIHelper', 'https://github.com/XiaoleC05/AIHelper/releases'),
