  ...
  const copyApiKey = async () => {
    try {
      ...
      if (k && k.length > 4) {
        ...
        catch { const ta = document.createElement('textarea'); ta.value = k; ta.style.cssText = 'position:fixed;left:-9999px'; document.body.appendChild(ta); ta.select(); document.execCommand('copy'); document.body.removeChild(ta) }
