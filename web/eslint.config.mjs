  ...
  ...storybook.configs["flat/recommended"],
  {
    ...
    rules: {
      ...
      "tailwindcss/no-custom-classname": [
        ...
        {
          whitelist: [
            // Oxelia51 design-system classes defined in src/styles (ox-page-in,
            // ox-stagger, ox-site-page, ox-hero-in, ox-card-hover, ox-orbit, …).
            "ox-.*",
      ...
      "no-restricted-imports": [
        "error",
        {
          patterns: [
            ...
            {
              // Relative paths escaping web/ bypass @oxelia51/shared's exports
