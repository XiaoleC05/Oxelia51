...
import { hasAnyTrace, createTracesCh } from "@oxelia51/shared/src/server";
import { createTrace } from "@oxelia51/shared/src/server";
import { v4 } from "uuid";

const projectId = "7a88fb47-b4e2-43b8-a06c-a5ce950dc53a";
const orgId = "7a88fb47-b4e2-43b8-a06c-a5ce950dc53b";

describe("hasAnyTrace", () => {
  beforeAll(async () => {
    // The langfuse seeder that used to create this project was removed from
    // the fork — create the fixture rows this suite depends on instead.
    await prisma.organization.create({
      data: {
        id: orgId,
        name: "hasAnyTrace Test Org",
        projects: { create: [{ id: projectId, name: "Seed Project" }] },
      },
    });
  });
