...
**Q：支持哪些模型？**
A：内置 12 条供应商路由，覆盖 11 家主流厂商——国内（DeepSeek、智谱、通义、Kimi、Kimi For Coding、豆包、混元、MiniMax）与国外（Anthropic、OpenAI、Gemini、xAI）；预设之外的平台（中转站、自建网关等）可在接入页添加[自定义供应商](/docs/custom-provider)接入。内置 71 个模型参考价（仅收录 11 家厂商官方在售模型，2026-09-02 按官方价核实），支持美元/人民币切换。
