...
import { encrypt } from "@oxelia51/shared/encryption";
import { SsoProviderSchema } from "./types";
import { validateSsoConfig } from "@/src/features/auth/multi-tenant-sso/validateSsoConfig";
import { TRPCError } from "@trpc/server";
import { type NextApiRequest, type NextApiResponse } from "next";
import { env } from "@/src/env.mjs";
import { logger } from "@oxelia51/shared/src/server";
import { multiTenantSsoAvailable } from "@/src/features/auth/multi-tenant-sso/multiTenantSsoAvailable";
